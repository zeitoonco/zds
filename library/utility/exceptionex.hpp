...
#define EXexceptionExO(msg, owner) new zeitoon::utility::exceptionEx(msg,owner,__FILE__,__LINE__)
#define EXTexceptionExO(msg, owner) throw EXexceptionExO(msg,owner)
#define EXexceptionExI(msg, inner) new zeitoon::utility::exceptionEx(msg,this->getNameAndType(),__FILE__,__LINE__,inner)
#define EXTexceptionExI(msg, inner) throw EXexceptionExI(msg,inner)
#define EXexceptionExIO(msg, owner, inner) new zeitoon::utility::exceptionEx(msg,owner,__FILE__,__LINE__,inner)
#define EXTexceptionExIO(msg, owner, inner) throw EXexceptionExIO(msg,owner,inner)
//invalidParameter
#define EXinvalidParameter(msg) new zeitoon::utility::invalidParameter(msg,this->getNameAndType(),__FILE__,__LINE__)
#define EXTinvalidParameter(msg) throw EXinvalidParameter(msg)
#define EXinvalidParameterO(msg, owner) new zeitoon::utility::invalidParameter(msg,owner,__FILE__,__LINE__)
#define EXTinvalidParameterO(msg, owner) throw EXinvalidParameterO(msg,owner)
#define EXinvalidParameterI(msg, inner) new zeitoon::utility::invalidParameter(msg,this->getNameAndType(),__FILE__,__LINE__,inner)
#define EXTinvalidParameterI(msg, inner) throw EXinvalidParameterI(msg,inner)
#define EXinvalidParameterIO(msg, owner, inner) new zeitoon::utility::invalidParameter(msg,owner,__FILE__,__LINE__,inner)
#define EXTinvalidParameterIO(msg, owner, inner) throw EXinvalidParameterIO(msg,owner,inner)
//namesMismatch
#define EXnamesMismatch(msg) new zeitoon::utility::namesMismatch(msg,this->getNameAndType(),__FILE__,__LINE__)
#define EXTnamesMismatch(msg) throw EXnamesMismatch(msg)
#define EXnamesMismatchO(msg, owner) new zeitoon::utility::namesMismatch(msg,owner,__FILE__,__LINE__)
#define EXTnamesMismatchO(msg, owner) throw EXnamesMismatchO(msg,owner)
#define EXnamesMismatchI(msg, inner) new zeitoon::utility::namesMismatch(msg,this->getNameAndType(),__FILE__,__LINE__,inner)
#define EXTnamesMismatchI(msg, inner) throw EXnamesMismatchI(msg,inner)
#define EXnamesMismatchIO(msg, owner, inner) new zeitoon::utility::namesMismatch(msg,owner,__FILE__,__LINE__,inner)
#define EXTnamesMismatchIO(msg, owner, inner) throw EXnamesMismatchIO(msg,owner,inner)
//dataTypeMismatch
#define EXdataTypeMismatch(msg) new zeitoon::utility::dataTypeMismatch(msg,this->getNameAndType(),__FILE__,__LINE__)
#define EXTdataTypeMismatch(msg) throw EXdataTypeMismatch(msg)
#define EXdataTypeMismatchO(msg, owner) new zeitoon::utility::dataTypeMismatch(msg,owner,__FILE__,__LINE__)
#define EXTdataTypeMismatchO(msg, owner) throw EXdataTypeMismatchO(msg,owner)
#define EXdataTypeMismatchI(msg, inner) new zeitoon::utility::dataTypeMismatch(msg,this->getNameAndType(),__FILE__,__LINE__,inner)
#define EXTdataTypeMismatchI(msg, inner) throw EXdataTypeMismatchI(msg,inner)
#define EXdataTypeMismatchIO(msg, owner, inner) new zeitoon::utility::dataTypeMismatch(msg,owner,__FILE__,__LINE__,inner)
#define EXTdataTypeMismatchIO(msg, owner, inner) throw EXdataTypeMismatchIO(msg,owner,inner)
//cantParseString
#define EXcantParseString(msg) new zeitoon::utility::cantParseString(msg,this->getNameAndType(),__FILE__,__LINE__)
#define EXTcantParseString(msg) throw EXcantParseString(msg)
#define EXcantParseStringO(msg, owner) new zeitoon::utility::cantParseString(msg,owner,__FILE__,__LINE__)
#define EXTcantParseStringO(msg, owner) throw EXcantParseStringO(msg,owner)
#define EXcantParseStringI(msg, inner) new zeitoon::utility::cantParseString(msg,this->getNameAndType(),__FILE__,__LINE__,inner)
#define EXTcantParseStringI(msg, inner) throw EXcantParseStringI(msg,inner)
#define EXcantParseStringIO(msg, owner, inner) new zeitoon::utility::cantParseString(msg,owner,__FILE__,__LINE__,inner)
#define EXTcantParseStringIO(msg, owner, inner) throw EXcantParseStringIO(msg,owner,inner)
//outOfRange
#define EXoutOfRange(msg) new zeitoon::utility::outOfRange(msg,this->getNameAndType(),__FILE__,__LINE__)
#define EXToutOfRange(msg) throw EXoutOfRange(msg)
#define EXoutOfRangeO(msg, owner) new zeitoon::utility::outOfRange(msg,owner,__FILE__,__LINE__)
#define EXToutOfRangeO(msg, owner) throw EXoutOfRangeO(msg,owner)
#define EXoutOfRangeI(msg, inner) new zeitoon::utility::outOfRange(msg,this->getNameAndType(),__FILE__,__LINE__,inner)
#define EXToutOfRangeI(msg, inner) throw EXoutOfRangeI(msg,inner)
#define EXoutOfRangeIO(msg, owner, inner) new zeitoon::utility::outOfRange(msg,owner,__FILE__,__LINE__,inner)
#define EXToutOfRangeIO(msg, owner, inner) throw EXoutOfRangeIO(msg,owner,inner)
//notImplemented
#define EXnotImplemented(msg) new zeitoon::utility::notImplemented(msg,this->getNameAndType(),__FILE__,__LINE__)
#define EXTnotImplemented(msg) throw EXnotImplemented(msg)
#define EXnotImplementedO(msg, owner) new zeitoon::utility::notImplemented(msg,owner,__FILE__,__LINE__)
#define EXTnotImplementedO(msg, owner) throw EXnotImplementedO(msg,owner)
#define EXnotImplementedI(msg, inner) new zeitoon::utility::notImplemented(msg,this->getNameAndType(),__FILE__,__LINE__,inner)
#define EXTnotImplementedI(msg, inner) throw EXnotImplementedI(msg,inner)
#define EXnotImplementedIO(msg, owner, inner) new zeitoon::utility::notImplemented(msg,owner,__FILE__,__LINE__,inner)
#define EXTnotImplementedIO(msg, owner, inner) throw EXnotImplementedIO(msg,owner,inner)
//invalidName
#define EXinvalidName(msg) new zeitoon::utility::invalidName(msg,this->getNameAndType(),__FILE__,__LINE__)
#define EXTinvalidName(msg) throw EXinvalidName(msg)
#define EXinvalidNameO(msg, owner) new zeitoon::utility::invalidName(msg,owner,__FILE__,__LINE__)
#define EXTinvalidNameO(msg, owner) throw EXinvalidNameO(msg,owner)
#define EXinvalidNameI(msg, inner) new zeitoon::utility::invalidName(msg,this->getNameAndType(),__FILE__,__LINE__,inner)
#define EXTinvalidNameI(msg, inner) throw EXinvalidNameI(msg,inner)
#define EXinvalidNameIO(msg, owner, inner) new zeitoon::utility::invalidName(msg,owner,__FILE__,__LINE__,inner)
#define EXTinvalidNameIO(msg, owner, inner) throw EXinvalidNameIO(msg,owner,inner)
//obsolete
#define EXobsolete(msg) new zeitoon::utility::obsolete(msg,this->getNameAndType(),__FILE__,__LINE__)
#define EXTobsolete(msg) throw EXobsolete(msg)
#define EXobsoleteO(msg, owner) new zeitoon::utility::obsolete(msg,owner,__FILE__,__LINE__)
#define EXTobsoleteO(msg, owner) throw EXobsoleteO(msg,owner)
#define EXobsoleteI(msg, inner) new zeitoon::utility::obsolete(msg,this->getNameAndType(),__FILE__,__LINE__,inner)
#define EXTobsoleteI(msg, inner) throw EXobsoleteI(msg,inner)
#define EXobsoleteIO(msg, owner, inner) new zeitoon::utility::obsolete(msg,owner,__FILE__,__LINE__,inner)
#define EXTobsoleteIO(msg, owner, inner) throw EXobsoleteIO(msg,owner,inner)
//unknownException
#define EXunknownException(msg) new zeitoon::utility::unknownException(msg,this->getNameAndType(),__FILE__,__LINE__)
#define EXTunknownException(msg) throw EXunknownException(msg)
#define EXunknownExceptionO(msg, owner) new zeitoon::utility::unknownException(msg,owner,__FILE__,__LINE__)
#define EXTunknownExceptionO(msg, owner) throw EXunknownExceptionO(msg,owner)
#define EXunknownExceptionI(msg, inner) new zeitoon::utility::unknownException(inner,msg,this->getNameAndType(),__FILE__,__LINE__)
#define EXTunknownExceptionI(msg, inner) throw EXunknownExceptionI(msg,inner)
#define EXunknownExceptionIO(msg, owner, inner) new zeitoon::utility::unknownException(inner,msg,owner,__FILE__,__LINE__)
#define EXTunknownExceptionIO(msg, owner, inner) throw EXunknownExceptionIO(msg,owner,inner)
//connectionError
#define EXconnectionError(msg) new zeitoon::utility::connectionError(msg,this->getNameAndType(),__FILE__,__LINE__)
#define EXTconnectionError(msg) throw EXconnectionError(msg)
#define EXconnectionErrorO(msg, owner) new zeitoon::utility::connectionError(msg,owner,__FILE__,__LINE__)
#define EXTconnectionErrorO(msg, owner) throw EXconnectionErrorO(msg,owner)
#define EXconnectionErrorI(msg, inner) new zeitoon::utility::connectionError(msg,this->getNameAndType(),__FILE__,__LINE__,inner)
#define EXTconnectionErrorI(msg, inner) throw EXconnectionErrorI(msg,inner)
#define EXconnectionErrorIO(msg, owner, inner) new zeitoon::utility::connectionError(msg,owner,__FILE__,__LINE__,inner)
#define EXTconnectionErrorIO(msg, owner, inner) throw EXconnectionErrorIO(msg,owner,inner)
//DBError
#define EXDBError(msg) new zeitoon::utility::DBError(msg,this->getNameAndType(),__FILE__,__LINE__)
#define EXTDBError(msg) throw EXDBError(msg)
#define EXDBErrorO(msg, owner) new zeitoon::utility::DBError(msg,owner,__FILE__,__LINE__)
#define EXTDBErrorO(msg, owner) throw EXDBErrorO(msg,owner)
#define EXDBErrorI(msg, inner) new zeitoon::utility::DBError(msg,this->getNameAndType(),__FILE__,__LINE__,inner)
#define EXTDBErrorI(msg, inner) throw EXDBErrorI(msg,inner)
#define EXDBErrorIO(msg, owner, inner) new zeitoon::utility::DBError(msg,owner,__FILE__,__LINE__,inner)
#define EXTDBErrorIO(msg, owner, inner) throw EXDBErrorIO(msg,owner,inner)
//duplicateName
#define EXduplicateName(msg) new zeitoon::utility::duplicateName(msg,this->getNameAndType(),__FILE__,__LINE__)
#define EXTduplicateName(msg) throw EXduplicateName(msg)
#define EXduplicateNameO(msg, owner) new zeitoon::utility::duplicateName(msg,owner,__FILE__,__LINE__)
#define EXTduplicateNameO(msg, owner) throw EXduplicateNameO(msg,owner)
#define EXduplicateNameI(msg, inner) new zeitoon::utility::duplicateName(msg,this->getNameAndType(),__FILE__,__LINE__,inner)
#define EXTduplicateNameI(msg, inner) throw EXduplicateNameI(msg,inner)
#define EXduplicateNameIO(msg, owner, inner) new zeitoon::utility::duplicateName(msg,owner,__FILE__,__LINE__,inner)
#define EXTduplicateNameIO(msg, owner, inner) throw EXduplicateNameIO(msg,owner,inner)
//nullValue
#define EXnullValue(msg) new zeitoon::utility::nullValue(msg,this->getNameAndType(),__FILE__,__LINE__)
#define EXTnullValue(msg) throw EXnullValue(msg)
#define EXnullValueO(msg, owner) new zeitoon::utility::nullValue(msg,owner,__FILE__,__LINE__)
#define EXTnullValueO(msg, owner) throw EXnullValueO(msg,owner)
#define EXnullValueI(msg, inner) new zeitoon::utility::nullValue(msg,this->getNameAndType(),__FILE__,__LINE__,inner)
#define EXTnullValueI(msg, inner) throw EXnullValueI(msg,inner)
#define EXnullValueIO(msg, owner, inner) new zeitoon::utility::nullValue(msg,owner,__FILE__,__LINE__,inner)
#define EXTnullValueIO(msg, owner, inner) throw EXnullValueIO(msg,owner,inner)
//networkFailure
#define EXnetworkFailure(msg) new zeitoon::utility::networkFailure(msg,this->getNameAndType(),__FILE__,__LINE__)
#define EXTnetworkFailure(msg) throw EXnetworkFailure(msg)
#define EXnetworkFailureO(msg, owner) new zeitoon::utility::networkFailure(msg,owner,__FILE__,__LINE__)
#define EXTnetworkFailureO(msg, owner) throw EXnetworkFailureO(msg,owner)
#define EXnetworkFailureI(msg, inner) new zeitoon::utility::networkFailure(msg,this->getNameAndType(),__FILE__,__LINE__,inner)
