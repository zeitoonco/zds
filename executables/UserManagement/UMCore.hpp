...
public:
	...
	UMLoginResult::UMLoginResultEnum login(std::string username, std::string password, int& sessionID,	//UMLoginResult
			std::string& desc);
	 ...
	 */
	std::vector<zeitoon::datatypes::DTString> listUsers();
	 ...
	 */
	std::vector<zeitoon::datatypes::DTString> listUsersByGroup(int groupID);
	 ...
	 * @return vector<"zeitoon::datatypes::DTString">
	 */
	std::vector<zeitoon::datatypes::DTString> listPermissions();
