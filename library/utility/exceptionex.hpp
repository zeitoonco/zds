...
#define EXTinvalidParameterO(msg,owner) throw EXinvalidParameter(msg,owner)
...
#define EXTnamesMismatchO(msg,owner) throw EXnamesMismatch(msg,owner)
...
#define EXTdataTypeMismatchO(msg,owner) throw EXdataTypeMismatch(msg,owner)
...
#define EXTcantParseStringO(msg,owner) throw EXcantParseString(msg,owner)
...
#define EXToutOfRangeO(msg,owner) throw EXoutOfRange(msg,owner)
...
#define EXTnotImplementedO(msg,owner) throw EXnotImplemented(msg,owner)
...
#define EXTinvalidNameO(msg,owner) throw EXinvalidName(msg,owner)
...
#define EXTobsoleteO(msg,owner) throw EXobsolete(msg,owner)
...
#define EXTunknownExceptionO(msg,owner) throw EXunknownException(msg,owner)
